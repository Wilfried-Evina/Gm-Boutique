<template>
  <div v-if="isOpen" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
    <div class="bg-white rounded-xl shadow-2xl p-6 w-full max-w-sm flex flex-col items-center text-center relative">
      ...
      <h2 class="text-xl font-bold text-gray-800 mb-2">Signature Cliente</h2>
      <p class="text-sm text-gray-500 mb-6">
        Demandez à la cliente de scanner ce QR Code avec son smartphone pour signer.
      </p>
      ...
      <!-- Statut -->
      <div class="flex items-center gap-2 text-indigo-600 bg-indigo-50 px-4 py-2 rounded-full text-sm font-medium">
