<template>
  <div class="space-y-6">
    <div class="sm:flex sm:items-center sm:justify-between">
      <div>
        <h1 class="text-2xl font-semibold text-gray-900">Articles vendus</h1>
        <p class="mt-2 text-sm text-gray-700">Historique de vos ventes et part boutique / cliente.</p>
      </div>
    ...
    >
      ...
      <template #cell-actions="{ row: item }">
        <div class="flex justify-end space-x-2">
          <!-- TODO: Ajouter détails rétrocession si payé -->
        </div>
      </template>
    </DataTable>
